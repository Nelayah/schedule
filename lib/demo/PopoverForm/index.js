...
let default_1 = class default_1 extends React.Component {
    ...
    constructor() {
        ...
        this.handleConfirm = () => {
            ...
            form.validateFields((err, value) => {
                if (err)
                    return;
                onOk(updateCallbackData(Object.assign({}, initialValue, value)));
            });
        };
    ...
    get handleFormRender() {
        ...
        return (React.createElement(Form, { style: { width: 300 }, onSubmit: this.handleConfirm },
            ...
            React.createElement(FormItem, { label: "Scheduler Content" }, form.getFieldDecorator('content', {
